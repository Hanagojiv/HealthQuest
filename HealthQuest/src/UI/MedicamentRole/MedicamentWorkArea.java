 ...
 */
public class MedicamentWorkArea extends javax.swing.JPanel {

    /**
     * Creates new form MedicamentWorkArea
     */
    ...
    private static Logger log = Logger.getLogger(MedicamentWorkArea.class);
    private static final String CLASS_NAME = MedicamentWorkArea.class.getName();

    public MedicamentWorkArea(JPanel userProcessContainer, UserAccount userAccount, MedicamentOrganization organization, Enterprise enterprise, Location network) {
        initComponents();
    ...
    public void populateDocTable() {
        ...
        for (WorkRequest request : pharmorg.getWorkQueue().getWorkRequestList()) {
            System.out.println("entering medication");
             ...
             if(request instanceof MedicalWorkRequest){
            Object[] row = new Object[3];
            row[0] = ((MedicalWorkRequest) request).getMedicationName();
            row[1] = ((MedicalWorkRequest) request).getQuantity();
            row[2] = ((MedicalWorkRequest) request).getStatus();
    ...
    private void initComponents() {
        ...
        add(jScrollPane);
        jScrollPane.setBounds(170, 650, 714, 177);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(126, 111, 871, 238);
        ...
        reqQuantityTxtField.setBounds(560, 510, 252, 30);

        viewRequestsBtn.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        ...
        add(viewRequestsBtn);
        viewRequestsBtn.setBounds(840, 510, 220, 35);

        addMedicineBtn.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        ...
        add(addMedicineBtn);
        addMedicineBtn.setBounds(410, 580, 251, 35);

        viewDetailsBtn.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        ...
        add(viewDetailsBtn);
        viewDetailsBtn.setBounds(840, 440, 200, 35);

        statusCheckBtn.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        statusCheckBtn.setForeground(new java.awt.Color(0, 0, 102));
        statusCheckBtn.setText("Order");
        ...
        add(statusCheckBtn);
        statusCheckBtn.setBounds(890, 380, 110, 35);

        pharmacyLbl.setFont(new java.awt.Font("Times New Roman", 3, 48)); // NOI18N
        pharmacyLbl.setForeground(new java.awt.Color(0, 0, 102));
        pharmacyLbl.setText("Pharmacy Work Area");
        add(pharmacyLbl);
        pharmacyLbl.setBounds(380, 60, 432, 56);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/female-pharmacist-advising-by-phone-call-healthcare-medical-concept_54401-529.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        add(jLabel1);
        jLabel1.setBounds(-470, -140, 1740, 1030);
        ...
        for (MedicalInventory mi : pharmorg.getMedList()) {
            ...
            if (mi.getAvailQuantity() <= mi.getRequiredQuantity()) {
                if (!mi.getReorderStatus().equals("Y")) {
                    BioTechnologyWorkRequest request = new BioTechnologyWorkRequest();
                    
                    mi.setReorderStatus("Y");
                    request.setBioTechnologyName(mi.getMedicineName());
                    ...
                    for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                        ...
                        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                            ...
                            if (organization.getName().equals("BioTechnology Organization")) {
                                ...
                                log.debug(userAccount+" "+"sending request to BioTechnology Organization");
                            }
                        }
