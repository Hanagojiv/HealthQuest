...
public class PrescriptionJPanel extends javax.swing.JPanel {
    ...
    public PrescriptionJPanel(JPanel userProcessContainer, PrescriptionList List, UserAccount account, Enterprise enterprise, DoctorOrganization organization, EcoSystem system, Location network) {
        initComponents();
    ...
    private void savePrescriptionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePrescriptionBtnActionPerformed
        ...
        if (flag == true) {
            ...
            Organization org = null;
                ...
                for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof MedicamentOrganization) {
                            org = organization;
            ...
            if (org != null) {
                ...
                log.debug("request sent to medicament");
            }
    ...
    public void populateWorkRequestTable() {
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()) {
            if (request instanceof MedicalWorkRequest) {
                ...
                String medication = ((MedicalWorkRequest) request).getMedicationName();

                System.out.println("****" + medication);
                row[0] = (MedicalWorkRequest) request;
                int quantity = ((MedicalWorkRequest) request).getQuantity();
                row[1] = quantity;
