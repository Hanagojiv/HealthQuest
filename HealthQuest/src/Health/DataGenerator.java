...
import Health.Organization.AdminOrganization;
import Health.WorkQueue.DoctorWorkRequest;
...
public class DataGenerator {
    ...
    private static String[] organisationName = {"Doctor", "Lab", "medicament", "BioTechnology", "Chemical"};
